  ...
  return (
    <aside className="sidebar w-[404px] border-r border-stone-200">
      <ul className="sidebar_menu pb-3 pt-8">
        ...
        <li className="">
          <a className="flex h-8 px-3" href="#">
            <img className="mr-2 h-6" src={armchair} alt="Laptops and PCs" />
            <span className="text-stone-700 hover:text-green-500">
              Товари для дому
            </span>
          </a>
        ...
        <li className="">
          <a className="flex h-8 px-3" href="#">
            <img className="mr-2 h-6" src={paperClip} alt="Laptops and PCs" />
            <span className="text-stone-700 hover:text-green-500">
              Офіс, школа, книги
            </span>
          </a>
      ...
      <div>
        <a className="flex border-t px-3 py-2" href="#">
          <img className="mr-2 h-6" src={telegramGreen} alt="Чат з ROZETKA" />
          <span className="text-green-600 hover:underline">Чат з ROZETKA</span>
        </a>
      </div>
      <div>
        <a className="flex border-t px-3 py-2" href="#">
      ...
      <div>
        <a className="flex border-t px-3 py-2" href="#">
          <img className="mr-2 h-6" src={parcelTracking} alt="Чат з ROZETKA" />
          <span className="text-stone-700 hover:text-green-500">
            Відстежити посилку
          </span>
        </a>
      ...
      <div>
        <div className="text-stone-703 m-4 flex flex-col items-center justify-center rounded-lg bg-gray-100 p-4 text-xs text-gray-600">
          <p>
            Увійдіть, щоб отримувати рекомендації, персональні бонуси і знижки.
          </p>
          <button
            className="mt-4 rounded-lg bg-[#3e77aa] px-3 py-2 text-sm text-white"
            type="button"
          >
      ...
      <div className="px-6 py-4">
        ...
        <div className="mb-1 border-b py-4">
          <h1 className="px-2 font-bold text-gray-500">Партнерам</h1>
          <ul className="mt-4 text-sm text-stone-700">
            <li className="h-[32px] px-2 py-[2px] hover:underline">
...
function MainPage() {
  return (
    <div className="layout flex justify-center px-[32px]">
